...
[Y,U]=closed_loop_roll_neural(0,0,rolling_MPC,x.T,0)
visualize_Y_vs_U(Y,U)
[Y,U,X]=open_loop_roll_neural(0,0,rolling_MPC,x.T,0)
visualize_Y_vs_U(Y,U)
[Y,U]=closed_loop_shr_neural(0,0,shrinking_MPC,x.T,0)
visualize_Y_vs_U(Y,U)
[Y,U,X]=open_loop_shr_neural(0,0,shrinking_MPC,x.T,0)
visualize_Y_vs_U(Y,U)